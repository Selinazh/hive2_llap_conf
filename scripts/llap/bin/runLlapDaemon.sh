...
HADOOP_CLASSPATH=/usr/local/Cellar/hadoop/2.7.3/libexec/etc/hadoop:/usr/local/Cellar/hadoop/2.7.3/libexec/share/hadoop/common/lib/*:/usr/local/Cellar/hadoop/2.7.3/libexec/share/hadoop/common/*:/usr/local/Cellar/hadoop/2.7.3/libexec/share/hadoop/hdfs:/usr/local/Cellar/hadoop/2.7.3/libexec/share/hadoop/hdfs/lib/*:/usr/local/Cellar/hadoop/2.7.3/libexec/share/hadoop/hdfs/*:/usr/local/Cellar/hadoop/2.7.3/libexec/share/hadoop/yarn/lib/*:/usr/local/Cellar/hadoop/2.7.3/libexec/share/hadoop/yarn/*:/usr/local/Cellar/hadoop/2.7.3/libexec/share/hadoop/mapreduce/lib/*:/usr/local/Cellar/hadoop/2.7.3/libexec/share/hadoop/mapreduce/*:/usr/local/Cellar/hadoop/2.7.3/libexec/share/hadoop/common/lib/htrace-core-3.1.0-incubating.jar:/usr/local/Cellar/hadoop/2.7.3/libexec/share/hadoop/hdfs/hadoop-hdfs-2.7.3.jar:ql/target/classes:/usr/local/Cellar/hadoop/2.7.3/libexec/share/hadoop/common/hadoop-common-2.7.3.jar:/usr/local/Cellar/hadoop/2.7.3/libexec/share/hadoop/common/lib/hadoop-auth-2.7.3.jar:/usr/local/Cellar/hadoop/2.7.3/libexec/share/hadoop/mapreduce/hadoop-mapreduce-client-core-2.7.3.jar:/usr/local/Cellar/hadoop/2.7.3/libexec//contrib/capacity-scheduler/*.jar
...
CLASSPATH=${HADOOP_CLASSPATH}:${LLAP_DAEMON_CONF_DIR}:${LLAP_DAEMON_HOME}/lib/*:${LLAP_DAEMON_HOME}/lib/tez/*:${LLAP_DAEMON_HOME}/lib/udfs/*:.
